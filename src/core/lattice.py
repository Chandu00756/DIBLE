#!/usr/bin/env python3
"""Learning-With-Errors lattice primitives (research-grade)."""
...
class LatticeOperations:
    ...
    def generate_random_matrix(self, rows: int, cols: int) -> np.ndarray:
        ...
        return rng.integers(0, self.modulus, size=(rows, cols), dtype=np.int64)
    ...
    def generate_keypair(self) -> dict:
        ...
        e = rng.integers(0, 4, size=self.dimension, dtype=np.int64)  # small error
